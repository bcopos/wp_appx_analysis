...
Our analysis was also able to detect a few cases in which the Javascript can cause the application to display the phone call UI and can control the number automatically inserted into the UI.
Furthermore, our analysis discovered that none of the applications using Javascript handlers verify the calling URI.
\end{abstract}
...
Also, the programmatically controlled number inserted into the phone UI is controlled by the Javascript.
